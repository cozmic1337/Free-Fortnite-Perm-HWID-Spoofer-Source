...
namespace KeyAuth
{
    public class api
    {
        ...
        public api(string name, string ownerid, string secret, string version)
        {
            if (ownerid.Length != 10 || secret.Length != 64)
            {
                ...
                Thread.Sleep(2000);
                error("Error 0x000003b, Contact : diskpartmgr");
                Environment.Exit(0);
            }
        ...
        public void init()
        {
            ...
            {
                error("Error 0x000001b, Contact : diskpartmgr");
                Environment.Exit(0);
            }
        ...
        public void CheckInit()
        {
            if (!initialized)
            {
                error("Error 0x000002b, Contact : diskpartmgr");
                Environment.Exit(0);
            }
        }
	...
	public void logout()
        ...
        public static void error(string message)
        {
            ...
            Process.Start(new ProcessStartInfo("cmd.exe", $"/c start cmd /C \"color c && title SoarProtectedAuth && echo {message} && pause >nul\"")
            {
                CreateNoWindow = true,
        ...
        { 
            ...
            {
                error("Error 0x000005b, Contact : diskpartmgr");
                return false;
            }
            return true;
        }
        ...
        private static void sigCheck(string resp, string signature, string type)
        {
            ...
            try
            {
                ...
                {
                    error("Error 0x000004b, Contact : diskpartmgr");
                    Environment.Exit(0);
                }
            }
            catch
